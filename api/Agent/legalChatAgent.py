...
class LegalChatAgent:
    ...
    def initialize_context(self, contract_text: str, shadow_analysis: str, summary_analysis: Dict[str, Any]):
        """
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "messages": [
                        {
                            "role": "system",
                            "content": """You are an expert legal assistant specialized in employment contracts.
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "messages": [
                        {
                            "role": "system",
                            "content": f"""Explain the '{aspect}' aspect of the contract in detail.
...
if __name__ == "__main__":
    ...
    chat_agent.initialize_context(contract, shadow_analysis, summary_analysis)
